						...
						<form action="<?php site_url('admin/user/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama_lengkap') ? 'is-invalid':'' ?>"
								 type="text" name="nama_lengkap" placeholder="Nama lengkap" value="<?php echo $user->nama_lengkap ?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('telepon') ? 'is-invalid':'' ?>"
								 type="text" name="telepon" min="0" placeholder="Nomor Telepon" value="<?php echo $user->telepon ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('jabatan') ? 'is-invalid':'' ?>"
								 type="text" name="jabatan" min="0" placeholder="Jabatan" value="<?php echo $user->jabatan ?>" />
								<div class="invalid-feedback">
