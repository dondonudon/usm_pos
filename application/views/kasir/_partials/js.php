...
<script src="<?php echo base_url('asset/sb-admin/sb-admin.min.js') ?>"></script>
<!-- Demo scripts for this page-->
<script src="<?php echo base_url('asset/sb-admin/demo/datatables-demo.js') ?>"></script>
<script src="<?php echo base_url('asset/sb-admin/demo/chart-area-demo.js') ?>"></script>